        ...
        <section className="bg-pergamino/90 backdrop-blur-md max-w-4xl mx-auto p-8 rounded-xl shadow-lg border border-forge">
          ...
          <form method="POST" className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            <div className="sm:col-span-2">
              <button
                type="submit"
                className="w-full bg-rune text-bg hover:text-pergamino hover:bg-dragon font-semibold py-3 rounded-md transition duration-300 focus:outline-none active:scale-95"
              >
                Enviar
              </button>
            </div>
