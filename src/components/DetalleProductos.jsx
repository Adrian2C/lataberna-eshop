            ...
            <main className="min-h-screen pt-24 pb-16 px-4 bg-druid">
                <div className="max-w-6xl mx-auto rounded-2xl p-4 shadow-2xl border border-forge/50 bg-pergamino">
                    <div className="mb-2">
                        <Link
                            to="/"
                            className="block w-fit px-10 py-3 text-lg font-bold bg-forge text-bg rounded-xl hover:bg-dragon hover:text-pergamino transition active:scale-95"
                        >
                            ← Volver atrás
                        </Link>
                    </div>
                    <section className="flex flex-col md:flex-row overflow-hidden rounded-xl shadow-md">
                        ...
                        <div className="p-6 md:w-1/2 flex flex-col justify-between space-y-6">
                            <div>
                                ...
                                <button
                                    className="w-full mt-6 py-3 font-semibold rounded-xl transition-colors duration-300 bg-rune hover:bg-dragon text-bg hover:text-pergamino active:scale-95"
