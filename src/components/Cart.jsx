                        ...
                        {cartItems.map((item, index) => (
                            <>
                                <li key={item.id} className="flex items-center justify-between gap-4 border-b pb-2 text-black min-h-[80px] ">
                                    ...
                                    <button onClick={() => borrarProducto(item)} className="w-8 h-8 flex justify-center items-center"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 text-red-400 hover:text-red-900">
